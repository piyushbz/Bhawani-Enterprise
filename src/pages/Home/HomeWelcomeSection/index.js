...
const stats = [
  { icon: <CalendarMonthOutlinedIcon style={{ fontSize: "2.2rem" }} />, label: "Established", value: "1864" },
  ...
  { icon: <LanguageOutlinedIcon style={{ fontSize: "2.2rem" }} />, label: "Overseas Clients", value: "100+" },
