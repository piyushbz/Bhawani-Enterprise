    ...
    >
      ...
      >
        ...
        >
          <Tab
            ...
            sx={{
              ...
              fontFamily: 'Cinzel, serif', // For a sophisticated feel
            }}
          />
          <Tab
            icon={<MissionIcon />}
        ...
        <TabContent value={activeTab} index={0}>
          <Typography variant="h5" gutterBottom sx={{ fontSize: { xs: '1.25rem', md: '1.5rem' }, fontFamily: 'Cinzel, serif', fontWeight: '700' }}>
            Our Vision
          </Typography>
          <Typography sx={{ fontSize: { xs: '0.9rem', md: '1rem' }, fontFamily: 'Lora, serif', fontWeight: 'bold', textAlign: 'justify' }}>
          ...
          <ul style={{ fontSize: { xs: '0.9rem', md: '1rem' }, fontFamily: 'Lora, serif', fontWeight: 'bold' }}>
